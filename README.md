# 转行职业规划skill-职业资产挖掘系统（Career Asset）

> 一个给 AI 编程助手用的结构化访谈 skill。帮有经验的职场人挖出被埋没的能力、把真实经历翻译成跨领域语言、生成中英双语的职业资产文档。方便在转行求职、职业规划过程中，做简历描述优化和职位搜索。

## 解决什么问题

大多数中高年限的职场人都被自己的职位名称困住了。一个管过 50+ 个项目、自己搭建了 AI 自动化流程的"景观设计师"，其实也是"复杂项目管理"+"AI 运营"——但简历上不会这么写。导致错过很多可以经验和技能兼容的职位。
...
**有一定工作经验，计划转行求职的人。** 不管你是做金融、IT、法律、医疗、设计、运营还是其他行业，方法论是一样的——把"做过什么"变成你的能力沉淀。AI 会根据你说的行业自动调整追问的方向和指标。
